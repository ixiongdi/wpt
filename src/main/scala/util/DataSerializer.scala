...
object DataSerializer {
  ...
  def DBObject2Thrift(o: DBObject, t: TBase[_ <: TBase[_, _], _ <: TFieldIdEnum])(convertor: String => TBase[_ <: TBase[_, _], _ <: TFieldIdEnum]) = {
    JSON2Thrift(DBObject2JSON(o), t)(convertor)
  }
  def JSON2DBObject(s: String) = JSON.parse(s).asInstanceOf[DBObject]
  def JSON2Thrift(s: String, t: TBase[_ <: TBase[_, _], _ <: TFieldIdEnum])(convertor: String => TBase[_ <: TBase[_, _], _ <: TFieldIdEnum]) = {
    convertor(s)
  }
